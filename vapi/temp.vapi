...
namespace Compat 
{
	...
	public static void activate_panel_preferences(GLib.SimpleAction action, GLib.Variant? param);
	[CCode (cname = "start_panels_from_dir", cheader_filename = "misc.h")]
	public static void activate_menu(GLib.SimpleAction action, GLib.Variant? param);
